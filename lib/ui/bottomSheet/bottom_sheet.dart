                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        value.modal != null &&
                                value.modal!.data != null &&
                                value.modal!.data!.assetsImages != null &&
                                value.modal!.data!.assetsImages!.isNotEmpty &&
                                value.modal!.data!.assetsImages!.isNotEmpty
...
//AddPhotosButton
                        ...
                        value.modal != null &&
                                value.modal!.data != null &&
                                value.modal!.data!.assetsNotes != null &&
                                value.modal!.data!.assetsNotes!.isNotEmpty &&
                                value.modal!.data!.assetsNotes!.isNotEmpty
                            ? Container(
                                ...
                                child: ReadMoreText(
                                  '${value.notesHeading}${value.modal?.data?.assetsNotes?.first.description ?? ''}',
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                itemCount: value.modal!.data!.assetsImages?.length ?? 0,
                                shrinkWrap: true,
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Container(
                                            ...
                                            color: Colors.yellow,
                                            child: Image.network(
                                              '$baseImageUrl1${value.modal!.data!.assetsImages?[index].image}',
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ),
...
//SubmitButton
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (widget.fromScreen == "Unscheduled") {
                                      value.emptyFunc();
                                      GoX.goPush(
                                          const ReadyToScanAssetNotification());
                                    } else {
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                              ...
                              width: 25,
                              child:
                                  Image.asset(AppImages.startScanBlockingIcon)),
                        ),
                      ],
                    ),
                  ],
