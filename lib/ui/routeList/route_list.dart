                            ...
                            itemBuilder: (context, index) {
                              return Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      print('modeldata?.data?[index].id.toString() --- > ${modeldata?.data?[index].id.toString()}');
                                      Navigator.of(context).maybePop();
                                      Future.microtask(() {
                                        context.read<ScanAssetProvider>().selectedRouteList(
                                            modeldata?.data?[index].id.toString(),
                                            modeldata?.data?[index].address.toString(),
                                            value.formatDateTime(modeldata?.data?[index].datetime).toString()
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  //StartTime
                                                  // value.demoRouteList[index]
                                                  //         .startTime.isNotEmpty
                                                  modeldata != null && modeldata!.data != null && modeldata!.data![index].datetime!.isNotEmpty
                                                      ? Text(
                                            ...
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                fontFamily:
                                                    FontFamily.neueMedium,
                                                color: index == 1
                                                    ? const Color(0xff20CB0E)
                                                    : index == 2
                                                        ? const Color(0xff2F71F5)
                                                        : index == 3
