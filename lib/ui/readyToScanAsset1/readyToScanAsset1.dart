...
class ReadyToScanAsset1 extends StatefulWidget {
  const ReadyToScanAsset1({super.key});

  @override
  State<ReadyToScanAsset1> createState() => _ReadyToScanState();
}

class _ReadyToScanState extends State<ReadyToScanAsset1> {
